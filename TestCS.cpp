...
// Global ptr variable for choices
int input;
int *ptrin = &input;
...
class dictionary
{
	private:
		...
		map <string,string> javsyn = {
			...
			{"print", "will perform the basic print"},
...
int main ()
{
	...
	switch (*ptrin) {
		...
		case 2:
		{
			cout 	<< "About:\n No need to search for different syntaxes online. This program enables you to search for a specific syntax that you want to know  from the 3 programming language (C++,Java, and Python).\n\n" 
					<< "Developers:\n" << "Agcaoili, Arnold Jansen\n" << "Magsino, Jon Raphael\n" << "Sahagun, Aaron John\n" << "Tolentino, Caren";
			break;
		}
